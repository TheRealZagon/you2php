...
<meta name="keywords" content="Youtube,Youtube unblocker,YouTube proxy,zagon,zagon proxy,web proxy,tube unblock,<?php echo $headtitle ?>" />
<meta name="description" content="A YouTube Mirror." />
	...
	<div class="collapse navbar-collapse text-center justify-content-end" id="navbar2SupportedContent">
		...
		<div id="custom-search-input">
			...
			<div class="input-group col-md-12">
				...
				<input type="text" name="q"  class="search-query form-control" id="youtube" placeholder="Search on YouTube"><span class="input-group-btn"><button class="btn btn-danger" type="submit" style="z-index:4"><span class="fa d-inline fa-search"></span></button></span>
				</div>
			</form>
		<script >
