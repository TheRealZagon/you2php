...
<div class="container d-lg-none d-md-none p-0">
 ...
 ?>
  ...
  <div class="container py-2">
    ...
    "> 
   <h3 class="pt-5 pb-2 text-white">Mirror Tube (Beta)</h3>
    <form>
  <div class="form-group" >
      <input type="text" name="v" style="width: 50%;height: 50px;border: none;box-sizing: border-box;padding: 14px 18px;" placeholder="Search..."  autocomplete="on" /><button type="submit"  style="width: 18%;border: none;height: 50px;background-color: #e62117;color: #fff;font-size: 18px;display: inline-block;" ><i class="fa fa-youtube-play fa-lg pr-1"></i>Go!</button>
  </div>
    </form>
    <p class="text-white m-0">Unblock your favorite videos!</p>
    </div>
    
    <div class="row pt-2 pb-2">
    <div class="col-8 sm-p">
      <span class="txt2 ricon h5">Popular now:</span>
    </div>
