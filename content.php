...
case 'category':
	...
	break;
case 'trending':
    $headtitle='Popular now'.' - '.SITE_NAME;
	break;
case 'DMCA':
    $headtitle='DMCA'.'-'.SITE_NAME;
	break;
case 'video':
    $headtitle='Video downloader'.' - '.SITE_NAME;
	break;
         ...
         <div class="col-md-9 relatedlist">
            ...
            switch ($cont) {
		        ...
		        echo '<div id="videocont"></div>
            		...
            		echo '<option '. $relevance .' data-url="./ajax/ajax.php?type=category&sortid='.$sortid.'&ptk='.$ptk.'">Popular videos</option>';
            		echo '<option ' . $date1 .' data-url="./ajax/ajax.php?type=category&sortid='.$sortid.'&order=date&ptk='.$ptk.'">Latest uploaded</option>';
